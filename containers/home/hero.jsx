...
<div class="follower"></div> */}
      ...
      <section className=" bg-black relative overflow-hidden scrollSection">
        ...
        <div className="h-full w-full bg-darkBg backdrop-blur-sm bg ">
          ...
          {/* \\\ CTA SECTION */}
          {/* \\\\\\\\\\\\\\\\\\\\\\\\\\\ */}
          <div className="cta px-5 lg:px-0 panel pt-12 lg:pt-24 w-screen  ">
            <div className="max-w-6xl 2xl:max-w-7xl mx-auto bg-primary w-full flex flex-col items-center justify-center gap-16 px-6 py-10 lg:p-20 rounded-b-[80px] lg:rounded-b-[128px]">
